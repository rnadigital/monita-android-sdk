...
import digital.rna.monita_android_sdk.monitoringConfig.MonitoringConfig
import digital.rna.monita_android_sdk.monitoringConfig.Vendor
import digital.rna.monita_android_sdk.sendData.ApiService
...
//                    logger.log("did not Matched vendor: ${vendor.vendorName} with URL pattern: $pattern")
    ...
    fun sendToMonita(request: Request, vendors: Vendor) {
        ...
        apiService.postData(
            ...
            appId = "digital.rnadigital.monita_android", // App ID
            sessionId = "", // Session ID
            consentString = "GRANTED", // Consent value
            hostAppVersion = "digital.rnadigital.monita_android", // Host app version
